...
<script>
    ...
    function calcCartSumPriceAndNumber(){
        ...
        $("img.cartProductItemIfSelected[selectit='selectit']").each(function(){
            ...
            price = price.replace(/[^0-9.]/g, ""); // 使用正则表达式将非数字和非点号的字符全部替换为空字符串
            price = parseFloat(price); // 将字符串转换为浮点数类型
            sum += price;
                    ...
                    <td>
                        <div class="cartProductLinkOutDiv">
                            ...
                            <div class="cartProductLinkInnerDiv">
                                <img src="img/site/creditcard.png" title="信用卡支付支持">
                                <img src="img/site/7day.png" title="七天无理由">

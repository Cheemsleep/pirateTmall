  ...
  $(function () {
    ...
    $("button.loginSubmitButton").click(function () {
      ...
      if (0 == name.length || 0 == password.length) {
        $("span.errorMessage").html("账号或密码为空");
...
<div class="imgAndInfo">
  ...
  <div class="infoInimgAndInfo">
    ...
    <div class="productPrice">
      <div class="juhuasuan">
        <span class="juhuasuanBig">好划算</span>
        <span>此商品即将参加好划算, <span class="juhuasuanTime">明天25:00</span>准时开始, </span>
      </div>
      ...
      <div class="productPriceDiv">
        ...
        <div class="promotionDiv">
          <span class="promotionPriceDesc">划算价 </span>
    ...
    <div class="serviceCommitment">
      <span class="serviceCommitmentDesc">服务承诺(假的)</span>
    ...
    <div class="buyDiv">
      <a class="buyLink" href="forebuyone?pid=${p.id}"><button class="buyButton">立刻购买</button></a>
